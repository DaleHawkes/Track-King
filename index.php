...
<h3>Import Data</h3>
<br />
<a href="import_race_data.php">Import Race Recording (File must be called samplefile.csv)</a><br />
<a href="import_race_recording.php">NEW Import Race Recording - File Upload Version</a><br />
<a href="import_race_information_form.php">Import Race Information (Actual race info like wind speed, mast rake etc)</a>
